			...
			<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
				...
				<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
					...
					<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
						...
						<!--end:Menu item-->
						<!-- Carné Postulante -->
						<div class="menu-item" v-if="is('Postulante') && ficha != 0 && ficha[0].id_estado_revision == 3 ">
							<!--begin:Menu link-->
						...
						<!-- Ficha de Postulante Ingresante  -->
						<div class="menu-item" v-if="is('Postulante')">
							<router-link class="menu-link" to="/ficha-ingresante" exact-active-class="active">
								<span class="menu-icon">
									<span class="svg-icon svg-icon-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path opacity="0.3" d="M19 22H5C4.4 22 4 21.6 4 21V3C4 2.4 4.4 2 5 2H14L20 8V21C20 21.6 19.6 22 19 22ZM12.5 18C12.5 17.4 12.6 17.5 12 17.5H8.5C7.9 17.5 8 17.4 8 18C8 18.6 7.9 18.5 8.5 18.5L12 18C12.6 18 12.5 18.6 12.5 18ZM16.5 13C16.5 12.4 16.6 12.5 16 12.5H8.5C7.9 12.5 8 12.4 8 13C8 13.6 7.9 13.5 8.5 13.5H15.5C16.1 13.5 16.5 13.6 16.5 13ZM12.5 8C12.5 7.4 12.6 7.5 12 7.5H8C7.4 7.5 7.5 7.4 7.5 8C7.5 8.6 7.4 8.5 8 8.5H12C12.6 8.5 12.5 8.6 12.5 8Z" fill="currentColor"/>
									<rect x="7" y="17" width="6" height="2" rx="1" fill="currentColor"/>
								...
								<span class="menu-title">Ficha Ingresante</span>
							</router-link>
						</div>
						<!--end:Menu item-->
						<!-- Simulacro -->
						...
						<!--end:Menu item-->
						<!-- Constancia Ingreso Postulante -->
						<div class="menu-item" v-if="is('Administrador')">
							<router-link class="menu-link" to="/documento-constancia" exact-active-class="active">
								<span class="menu-icon">
									<span class="svg-icon svg-icon-2">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor"></rect> 
								...
								<span class="menu-title">Documentos para Constancia Ingreso</span>
							</router-link>
						</div>
						
						<!--begin:Menu item-->
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion" v-if="is('Administrador') || is('Asesor') || is('Colaborador')">
							<!--begin:Menu link-->
							...
							<div class="menu-sub menu-sub-accordion">
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<router-link class="menu-link" to="/pagos-prospecto" exact-active-class="active">
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<router-link class="menu-link" to="/pagos-examen" exact-active-class="active">
										<span class="menu-bullet">
											<span class="bullet bullet-dot"></span>
										</span>
										<span class="menu-title">Derecho de examen</span>
									</router-link>
									<!--end:Menu link-->
								</div>
								<!--end:Menu item-->
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<router-link class="menu-link" to="/pagos-constancia" exact-active-class="active">
										<span class="menu-bullet">
											<span class="bullet bullet-dot"></span>
										</span>
										<span class="menu-title">Constancia Ingreso (S/.50.70)</span>
									</router-link>
									<!--end:Menu link-->
								</div>
								<!--end:Menu item-->
						...
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion" v-if="is('Administrador')||is('Asesor')||is('Asistente')||is('Colaborador')">
							<!--begin:Menu link-->
							<span class="menu-link">
								<span class="menu-icon">
									<!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-11-24-050857/core/html/src/media/icons/duotune/art/art005.svg-->
							...
							<div class="menu-sub menu-sub-accordion">
								<div class="menu-item" v-if="is('Administrador')||is('Asesor')||is('Asistente')||is('Colaborador')">
									<!--begin:Menu link-->
						...
						<div data-kt-menu-trigger="click" class="menu-item menu-accordion" v-if="is('Administrador') || is('Tesoreria') || is('Comision') || is('Colaborador')">
							...
							<div class="menu-sub menu-sub-accordion">
								...
								<div class="menu-item" v-if="is('Administrador') || is('Tesoreria')">
									<!--begin:Menu link-->
									<router-link class="menu-link" to="/reporte-pagos" exact-active-class="active">
										<span class="menu-bullet">
											<span class="bullet bullet-dot"></span>
										</span>
										<span class="menu-title">Pagos</span>
