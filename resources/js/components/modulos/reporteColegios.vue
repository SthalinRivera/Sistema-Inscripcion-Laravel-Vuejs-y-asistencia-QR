    ...
    <div>
        <div class="card mb-5 mb-xl-8">
            <div class="card-header border-0 pt-5">
                ...
                <span class="card-label fw-bold fs-3 mb-1">Reporte por Colegios</span>
                </h3>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-row-bordered">
                        ...
                        <tr v-else v-for="(dato, index) in data" :index="index" :key="index">
                            ...
                            <td class="ps-4">{{ dato.distrito }}</td>
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">            
                <span class="card-label fw-bold text-dark">Reporte por Colegios</span>
            </h3>
        </div>
        <div class="card-body">
