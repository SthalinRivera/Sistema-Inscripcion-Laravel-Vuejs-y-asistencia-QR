                            ...
                            <div class="modal fade" tabindex="-1" id="kt_modal_1" style="display: none;" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form id="requisitos-modalidad" @submit.prevent="guardarArchivo(subirDocumento)">
    ...
    methods: {
        ...
        async subirArchivo(id_documento, archivo, tipo) {
            ...
            this.axios.post(this.$parent.NombreRuta + `/api/documentos/` + id_documento + `?_method=PUT`, formData)
                .then((response) => {
                    const datos = {
            id_documento: response.data.id_documento, // o algún otro valor obtenido de la respuesta
        ...
        guardarArchivo(datos) {
            if(datos.created==0){
                ...
                // const { id_documento, archivo, tipo } = datos;
