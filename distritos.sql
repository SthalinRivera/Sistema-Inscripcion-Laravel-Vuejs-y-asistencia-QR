...
-- Tiempo de generación: 24-10-2022 a las 12:41:12
...
CREATE TABLE `distritos` (
  `id_distrito` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL,
  `distrito` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_provincia` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_departamento` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
INSERT INTO `distritos` (`id_distrito`, `distrito`, `id_provincia`, `id_departamento`) VALUES
